...
2.  Analyzing NY's "fusion" voting system
    ...
    >
    > -   ![](images/Screenshot%202024-11-11%20at%206.50.16%20PM.png)
...
The function get_congressional_shapefile() combines downlaoding the files, extracitng the shapefile,a nd reading into R. The funciton get_congressional_shapefile() serves the same purpose as read_shp_from_zip(), as provided in the sample code for Task 4.
